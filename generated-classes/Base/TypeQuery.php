 ...
 *
 * @method     ChildTypeQuery leftJoinItemType($relationAlias = null) Adds a LEFT JOIN clause to the query using the ItemType relation
 * @method     ChildTypeQuery rightJoinItemType($relationAlias = null) Adds a RIGHT JOIN clause to the query using the ItemType relation
 * @method     ChildTypeQuery innerJoinItemType($relationAlias = null) Adds a INNER JOIN clause to the query using the ItemType relation
 *
 * @method     ChildTypeQuery joinWithItemType($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the ItemType relation
 *
 * @method     ChildTypeQuery leftJoinWithItemType() Adds a LEFT JOIN clause and with to the query using the ItemType relation
 * @method     ChildTypeQuery rightJoinWithItemType() Adds a RIGHT JOIN clause and with to the query using the ItemType relation
 * @method     ChildTypeQuery innerJoinWithItemType() Adds a INNER JOIN clause and with to the query using the ItemType relation
 *
 * @method     \ItemTypeQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class TypeQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'store', $modelName = '\\Type', $modelAlias = null)
    {
    ...
    public function filterByItemType($itemType, $comparison = null)
    {
        if ($itemType instanceof \ItemType) {
            return $this
                ->addUsingAlias(TypeTableMap::COL_ID, $itemType->getTypeid(), $comparison);

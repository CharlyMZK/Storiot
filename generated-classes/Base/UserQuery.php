 ...
 *
 * @method     ChildUserQuery leftJoinCreditCard($relationAlias = null) Adds a LEFT JOIN clause to the query using the CreditCard relation
 * @method     ChildUserQuery rightJoinCreditCard($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CreditCard relation
 * @method     ChildUserQuery innerJoinCreditCard($relationAlias = null) Adds a INNER JOIN clause to the query using the CreditCard relation
 *
 * @method     ChildUserQuery joinWithCreditCard($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the CreditCard relation
 *
 * @method     ChildUserQuery leftJoinWithCreditCard() Adds a LEFT JOIN clause and with to the query using the CreditCard relation
 ...
 * @method     ChildUserQuery innerJoinReview($relationAlias = null) Adds a INNER JOIN clause to the query using the Review relation
 *
 * @method     ChildUserQuery joinWithReview($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Review relation
 *
 * @method     ChildUserQuery leftJoinWithReview() Adds a LEFT JOIN clause and with to the query using the Review relation
 * @method     ChildUserQuery rightJoinWithReview() Adds a RIGHT JOIN clause and with to the query using the Review relation
 * @method     ChildUserQuery innerJoinWithReview() Adds a INNER JOIN clause and with to the query using the Review relation
 *
...
abstract class UserQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'store', $modelName = '\\User', $modelAlias = null)
    {
    ...
    public function filterByCreditCard($creditCard, $comparison = null)
    {
        if ($creditCard instanceof \CreditCard) {
            return $this
                ->addUsingAlias(UserTableMap::COL_ID, $creditCard->getUserid(), $comparison);
    ...
    public function filterByReview($review, $comparison = null)
    {
        if ($review instanceof \Review) {
            return $this
                ->addUsingAlias(UserTableMap::COL_ID, $review->getUserid(), $comparison);

...
class PackageTableMap extends TableMap
{
     ...
     */
    const COL_ID = 'package.id';

    /**
     * the column name for the reference field
     */
    const COL_REFERENCE = 'package.reference';

    /**
     * the column name for the sendDate field
     */
    const COL_SENDDATE = 'package.sendDate';

    /**
     * the column name for the userId field
     */
    const COL_USERID = 'package.userId';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Reference', 'Senddate', 'Userid', ),
        self::TYPE_CAMELNAME     => array('id', 'reference', 'senddate', 'userid', ),
        self::TYPE_COLNAME       => array(PackageTableMap::COL_ID, PackageTableMap::COL_REFERENCE, PackageTableMap::COL_SENDDATE, PackageTableMap::COL_USERID, ),
        self::TYPE_FIELDNAME     => array('id', 'reference', 'sendDate', 'userId', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Reference' => 1, 'Senddate' => 2, 'Userid' => 3, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'reference' => 1, 'senddate' => 2, 'userid' => 3, ),
        self::TYPE_COLNAME       => array(PackageTableMap::COL_ID => 0, PackageTableMap::COL_REFERENCE => 1, PackageTableMap::COL_SENDDATE => 2, PackageTableMap::COL_USERID => 3, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'reference' => 1, 'sendDate' => 2, 'userId' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
  ...
  array (
    ...
    /**
     * Method to invalidate the instance pool of all tables related to package     * by a foreign key with ON DELETE CASCADE
     */
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(PackageTableMap::COL_REFERENCE);
            $criteria->addSelectColumn(PackageTableMap::COL_SENDDATE);
            $criteria->addSelectColumn(PackageTableMap::COL_USERID);
        } else {

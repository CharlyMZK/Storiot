...
class ReviewTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.ReviewTableMap';
     ...
     */
    const COL_STARS = 'review.stars';

    /**
     * the column name for the comment field
     */
    const COL_COMMENT = 'review.comment';

    /**
     * the column name for the userId field
     */
    const COL_USERID = 'review.userId';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Stars', 'Comment', 'Userid', ),
        self::TYPE_CAMELNAME     => array('id', 'stars', 'comment', 'userid', ),
        self::TYPE_COLNAME       => array(ReviewTableMap::COL_ID, ReviewTableMap::COL_STARS, ReviewTableMap::COL_COMMENT, ReviewTableMap::COL_USERID, ),
        self::TYPE_FIELDNAME     => array('id', 'stars', 'comment', 'userId', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Stars' => 1, 'Comment' => 2, 'Userid' => 3, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'stars' => 1, 'comment' => 2, 'userid' => 3, ),
        self::TYPE_COLNAME       => array(ReviewTableMap::COL_ID => 0, ReviewTableMap::COL_STARS => 1, ReviewTableMap::COL_COMMENT => 2, ReviewTableMap::COL_USERID => 3, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'stars' => 1, 'comment' => 2, 'userId' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('stars', 'Stars', 'FLOAT', false, 10, null);
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ReviewTableMap::COL_STARS);
            $criteria->addSelectColumn(ReviewTableMap::COL_COMMENT);
            $criteria->addSelectColumn(ReviewTableMap::COL_USERID);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.stars');

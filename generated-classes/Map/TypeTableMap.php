...
class TypeTableMap extends TableMap
{
     ...
     */
    const COL_ID = 'type.id';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'type.name';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(TypeTableMap::COL_ID, TypeTableMap::COL_NAME, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(TypeTableMap::COL_ID => 0, TypeTableMap::COL_NAME => 1, ),
  ...
  array (
    ...
    /**
     * Method to invalidate the instance pool of all tables related to type     * by a foreign key with ON DELETE CASCADE
     */
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(TypeTableMap::COL_NAME);
        } else {

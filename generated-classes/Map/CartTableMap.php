...
class CartTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(CartTableMap::COL_ID, CartTableMap::COL_USERID, ),
        self::TYPE_FIELDNAME     => array('id', 'userId', ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(CartTableMap::COL_ID => 0, CartTableMap::COL_USERID => 1, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'userId' => 1, ),
        self::TYPE_NUM           => array(0, 1, )
    );
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CartTableMap::COL_USERID);
        } else {

...
class OrderTableMap extends TableMap
{
     ...
     */
    const COL_REFERENCE = 'order.reference';

    /**
     * the column name for the sendDate field
     */
    const COL_SENDDATE = 'order.sendDate';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(OrderTableMap::COL_ID, OrderTableMap::COL_REFERENCE, OrderTableMap::COL_SENDDATE, OrderTableMap::COL_USERID, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(OrderTableMap::COL_ID => 0, OrderTableMap::COL_REFERENCE => 1, OrderTableMap::COL_SENDDATE => 2, OrderTableMap::COL_USERID => 3, ),
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(OrderTableMap::COL_REFERENCE);
            $criteria->addSelectColumn(OrderTableMap::COL_SENDDATE);
